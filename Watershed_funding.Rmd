...
pivot_funder_counts <- pivot_longer(project_counts_by_funder, c(pcsrf_funds, state_funds, other_funds))
...
funder_counts$funder <-
  sub( "pcsrf_funds", "PCSRF Funding", funder_counts$funder)

funder_counts$funder <-
  sub( "state_funds", "State Funding", funder_counts$funder)

funder_counts$funder <-
  sub( "other_funds", "Other Funding", funder_counts$funder)
